  ...
  public: {
    Tables: {
      ...
      store_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "store_settings_org_fk"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "store_settings_store_scope_fk"
            columns: ["store_id", "org_id"]
            isOneToOne: true
            referencedRelation: "stores"
            referencedColumns: ["id", "org_id"]
    ...
    Functions: {
      ...
      get_customer_detail: { Args: { p_payload: Json }; Returns: Json }
      get_sale_detail: { Args: { p_payload: Json }; Returns: Json }
      get_store_settings: { Args: { p_payload: Json }; Returns: Json }
      list_audit_events: { Args: { p_payload: Json }; Returns: Json }
      list_sales: { Args: { p_payload: Json }; Returns: Json }
      record_audit_event: { Args: { p_payload: Json }; Returns: Json }
      search_customers: { Args: { p_payload: Json }; Returns: Json }
      upsert_customer: { Args: { p_payload: Json }; Returns: Json }
      upsert_store_settings: { Args: { p_payload: Json }; Returns: Json }
