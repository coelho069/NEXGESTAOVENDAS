...
import { appendFixtureRefundCash } from "@/lib/pdv/cash-fixture-ledger";
      ...
      try {
        if (pdvFixturesEnabled()) {
          ...
          if (
            ...
            result.payment_refund_status === "completed" &&
            input.cashSessionId &&
            !result.replay
          ) {
            appendFixtureRefundCash({
