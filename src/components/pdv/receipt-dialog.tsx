...
export function ReceiptDialog({ open, receipt, onClose, onReconcile }: ReceiptDialogProps) {
  ...
  return (
    <div data-testid="receipt" className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <button type="button" className="absolute inset-0 bg-slate-900/60 backdrop-blur-sm" aria-label="Fechar recibo" onClick={onClose} />
      <div className="relative flex h-[90vh] w-full max-w-2xl flex-col rounded-2xl bg-white p-5 shadow-xl">
        <div className="mb-3 flex items-center justify-between gap-3">
          <div>
            <h2 className="text-lg font-semibold tracking-tight">Recibo</h2>
